...
class Options {
	...
	public static function defaults(): array {
		return [
			...
			'kronos_watermark_enable'   => false,
			'kronos_watermark_type'     => 'text',
			'kronos_watermark_text'     => '',
			'kronos_watermark_logo'     => 0,
			'kronos_watermark_position' => 'bottom-right',
			'kronos_watermark_opacity'  => 70,
