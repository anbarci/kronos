 ...
 * varsayılan "blog" ve `kronos_site_mode` filtresiyle override edilebilir.
 *
 * @package Kronos\Core
 */
...
class Mode {
	...
	public static function current(): string {
		$mode = (string) get_theme_mod( 'kronos_site_mode', self::BLOG );
		 ...
		 */
		$mode = apply_filters( 'kronos_site_mode', $mode );
	...
	public function body_class( array $classes ): array {
		$classes[] = 'kronos-mode-' . self::current();
		return $classes;
	}
}
